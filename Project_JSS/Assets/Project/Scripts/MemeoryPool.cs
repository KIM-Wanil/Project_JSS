...
public class MemoryPool
{
    ...
    public MemoryPool(GameObject poolObject, UnityEngine.Transform transform)
    {
        maxCount = 0;
        activeCount = 0;
    ...
    /// </summary>
    public void InstantiateObjects(UnityEngine.Transform transform)
    {
    ...
    /// </summary>
    public GameObject ActivatePoolItem(Vector3 position, UnityEngine.Transform transform)
    {
